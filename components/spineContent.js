...
export const SPINE_HOTSPOTS = [
  {
    id: 'cervical', number: 1, title: 'Cervical Spine', position: '0.15 0.4 0.12',
  ...
  {
    id: 'thoracic', number: 2, title: 'Thoracic Spine', position: '-0.15 0.16 0.12',
  ...
  {
    id: 'lumbar', number: 3, title: 'Lumbar Spine', position: '0.15 -0.17 0.12',
  ...
  {
    id: 'degeneration', number: 4, title: 'Disc Degeneration', position: '-0.15 -0.04 0.12',
  ...
  {
    id: 'compression', number: 5, title: 'Nerve Compression', position: '0.15 -0.29 0.12',
  ...
  {
    id: 'treatment', number: 6, title: 'Treatment Target', position: '-0.15 -0.39 0.12',
